...
VALUES
  ...
  (2, false, false, false, 'connecting the system will not do anything, we need to input the mobile AI panel!', 'Hey, it is Robin Scherbatsky here, Look, you cannot design your life like a building. It will not work that way. You just have to live it… and itll design itself.', 'gschool'),
  (3, false, false, false, 'We need to program the primary TCP hard drive!', 'Hey, Gary Blauman, Definitions are important.', 'dev'),
  ...
  (5, true, false, true, 'We need to back up the wireless GB driver...', 'Hello everyone it is Brad Morris: Because sometimes even if you know how something is gonna end that does not mean you cannot enjoy the ride.', 'gschool'),
